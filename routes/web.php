...
use App\Http\Controllers\MenuController as MenuUser;
...
Route::get('danh-muc/{id}-{slug}.html',[MenuUser::class,'index']);
Route::get('san-pham/{id}-{slug}.html',[ProductUser::class,'index']);
